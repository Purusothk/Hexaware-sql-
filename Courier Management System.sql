...
update Courier1 set startDate = '2024-09-01' where CourierID = 6
update Courier1 set startDate = '2024-09-09' where CourierID = 7
update Courier1 set startDate = '2024-08-24' where CourierID = 11
update Courier1 set startDate = '2024-09-01' where CourierID = 12
...
select * from Payment where Amount > 1000    and (PaymentDate > '2024-08-17' )
...
ALTER TABLE Courier1 ADD UserID INT;
UPDATE Courier1 SET  UserID = 1 WHERE CourierID = 1
UPDATE Courier1 SET  UserID = 2 WHERE CourierID = 2
UPDATE Courier1 SET  UserID = 3 WHERE CourierID = 3
UPDATE Courier1 SET  UserID = 4 WHERE CourierID = 4
UPDATE Courier1 SET  UserID = 5 WHERE CourierID = 5
UPDATE Courier1 SET  UserID = 6 WHERE CourierID = 6
UPDATE Courier1 SET  UserID = 7 WHERE CourierID = 7
UPDATE Courier1 SET  UserID = 11 WHERE CourierID = 11
UPDATE Courier1 SET  UserID = 12 WHERE CourierID = 12
UPDATE Courier1 SET  UserID = 16 WHERE CourierID = 16
UPDATE Courier1 SET  UserID = 17 WHERE CourierID = 17
UPDATE Courier1 SET  UserID = 18 WHERE CourierID = 18
select * from Courier1
...
alter table Courier1 add ServiceID INT;
UPDATE Courier1
SET ServiceID = CASE 
    when CourierID = 1 THEN 101  
    when CourierID = 2 THEN 102
    when CourierID = 3 THEN 103
    when CourierID = 4 THEN 104
    when CourierID = 5 THEN 105
	when CourierID = 6 THEN 106  
    when CourierID = 7 THEN 107
    when CourierID = 11 THEN 111
    when CourierID = 12 THEN 112
    when CourierID = 16  THEN 116
	when CourierID = 17 THEN 117  
    when CourierID = 18 THEN 118   
    else NULL   
end
...
alter table Courier1 add EmployeeID int 
UPDATE Courier1
SET EmployeeID = CASE 
    when CourierID = 1 then 2  
    when CourierID = 2 then 2  
    when CourierID = 3 then 1  
    when CourierID = 4 then 6  
    when CourierID = 5 then 1
	when CourierID = 6 then 2  
	when CourierID = 7 then 5  
	when CourierID = 11 then 1  
	when CourierID = 12 then 2  
	when CourierID = 16 then 11
	when CourierID = 17 then 12 
	when CourierID = 18 then 13  
    else NULL  
END;
